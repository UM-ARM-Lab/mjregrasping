...
from mjregrasping.grasp_and_settle import deactivate_moving, grasp_and_settle
...
def main():
    ...
    for i in range(0, 10):
        ...
        goals = [
            ThreadingGoal(grasp_goal, skeletons, 'loop1', subgoal_locs[1][0], subgoal_locs[1]),
            ...
            ThreadingGoal(grasp_goal, skeletons, 'loop2', subgoal_locs[5][0], subgoal_locs[5]),
            ...
            ThreadingGoal(grasp_goal, skeletons, 'loop3', subgoal_locs[9][0], subgoal_locs[9]),
            ...
            if isinstance(goal, ObjectPointGoal):
                ...
                if res:
                    if goal.satisfied_from_res(phy, res):
                        ...
                        deactivate_moving(phy, strategy, viz, is_planning=False, mov=mov)
