...
class RegraspMPC:
    ...
    def __init__(self, pool: ThreadPoolExecutor, mppi_nu: int, skeletons, sdf, seed: int, viz: Viz,
    ...
    def run_point_goal(self, phy: Physics, point_goal: ObjectPointGoal):
        ...
        while True:
            ...
            if np.any(is_stuck_vec):
                ...
                needs_reset = self.on_stuck(grasp_goal, point_goal, phy, planner)
    ...
    def on_stuck(self, grasp_goal: GraspGoal, op_goal, phy: Physics, planner: HomotopyRegraspPlanner):
        ...
        new_geodesic_cost = get_geodesic_dist(best_grasp.locs, op_goal)
