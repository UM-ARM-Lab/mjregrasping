...
def log_frame(frame: str = 'world', scale: float = 1):
    rr.log_view_coordinates(frame, up="+Z", timeless=True)
    rr.log_arrow(f'{frame}/x', [0, 0, 0], [scale, 0, 0], color=(255, 0, 0), width_scale=0.02 * scale)
    rr.log_arrow(f'{frame}/y', [0, 0, 0], [0, scale, 0], color=(0, 255, 0), width_scale=0.02 * scale)
    rr.log_arrow(f'{frame}/z', [0, 0, 0], [0, 0, scale], color=(0, 0, 255), width_scale=0.02 * scale)
