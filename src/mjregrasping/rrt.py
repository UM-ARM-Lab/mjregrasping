...
class GraspRRT:
    ...
    def plan(self, phy: Physics, strategy, locs: np.ndarray, viz: Viz, viz_execution: bool):
        ...
        res: MotionPlanResponse = self.rrt.plan(scene_msg, group_name, goals, viz_execution)
        return res
